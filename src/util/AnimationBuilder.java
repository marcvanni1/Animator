...
/**
 * An interface that defines the functions an AnimationBuilder performs. These include setting
 * boundaries, adding motions, and declaring shapes.
 *
 * @param <Doc> the animator model class name
 */
